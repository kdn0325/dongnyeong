---
title: "Sandbox: bash(43130) deny(1) file-write-create"
description: "Sandbox: bash(43130) deny(1) file-write-create"
date: 2024-06-17
published: true
tags:
  [
    ...
    " pod install,",
    " issues,",
    " bash(43130) deny(1) file-write-create",
    " 에러,",
  ]
---
...
```swift
Sandbox: bash(69431) deny(1) file-read-data /Users/abel/Desktop/Inc/streetcaster/app/ios/Pods/Target Support Files/Pods-streetcaster_app/expo-configure-project.sh
```
...
```lua
Targets - Build Settings에 가서 Filter에 User script 검색
```

User Script Sandboxing라고 나오는데 이걸 No로 변경
